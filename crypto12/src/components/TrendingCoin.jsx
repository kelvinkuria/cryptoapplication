...
const TrendingCoin = ({ data }) => {
  ...
  // Function to handle clicking on a coin to get its details
  ...
  return (
    <div
      ...
      onClick={() => handleCoinDetails(data.id)}
    >
      {data ? (
        ...
        <>
          ...
          <h3 className="txt-base flex items-center my-0.5">
            ...
            <span className="text-cyan">{new Intl.NumberFormat("en-IN", { style: "currency", currency: "btc", maximumSignificantDigits: 5 }).format(data.price_btc)}</span>
          </h3>
          <h3 className="txt-base flex items-center my-0.5">
        ...
        // Render a loading indicator if data is not available
